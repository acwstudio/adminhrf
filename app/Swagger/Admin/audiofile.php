 ...
 *      operationId="AdminAudiofileShow",
 *      tags={"Admin Audiofiles"},
 ...
 *          name="id",
 *          in="path",
 *          description="id of fetched audiofile",
 *          required=true,
 ...
 *  @OA\Post(
 *      path="/admin/audiofiles",
 *      operationId="AdminAudiofileCreate",
 *      tags={"Admin Audiofiles"},
 *      summary="Create a new audiofile resource",
 *
 *      @OA\RequestBody(
 *          required=true,
 *          description="Pass audiofile properties",
 *          @OA\MediaType(
 ...
 *      @OA\Response(
 *          response="422",
 *          description="File does not pass validation",
 *          @OA\MediaType(
 *              mediaType="application/json"
 *          )
 *      ),
 ...
 *          name="id",
 *          in="path",
 *          description="id of deleted audiofile",
 *          required=true,
 *          example="/audiofiles/3",
 *          @OA\Schema(
 *              type="integer",
